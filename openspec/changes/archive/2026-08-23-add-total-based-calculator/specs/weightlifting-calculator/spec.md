...
The system SHALL keep the Total consistent with the Snatch and Clean & Jerk fields: editing either lift directly recomputes the displayed Total, and the Total field is not independently hand-edited while it is being derived this way.
...
- **WHEN** a user chooses to edit the Total again after it was derived from Snatch/Clean & Jerk
- **THEN** the system allows a new Total value to be entered and re-generates split suggestions from it
